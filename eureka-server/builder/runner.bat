...
scp -i C:\Users\Akmal.Suranta\.ssh\ecommerce-project-microservice target/eureka-server-1.0.0.jar azureuser@20.247.180.27:/home/azureuser/ecommerce_builder/eureka-server
